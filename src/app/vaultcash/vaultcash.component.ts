...
if (this.uploadData.invalid) {
  ...
  this.previewColList = this.columnConfig.columnConfig.filter(x => x.datafor == this.fileType && x.bankcode == this.uploadData.cra);
...
// fileData.append('project_id', 'ALL');
...
viewColumnAll:any=[
  ...
  {
    name:"Amount",
    prop:"total_vault_balance"
  },
  {
    name:"Denomination 100",
    prop:"vault_balance_100"
  },
  {
    name:"Denomination 200",
    prop:"vault_balance_200"
  },
  {
    name:"Denomination 500",
    prop:"vault_balance_500"
  },
  {
    name:"Denomination 2000",
    prop:"vault_balance_2000"
  },
  {
    name:"Dependency",
    prop:"dependency"
